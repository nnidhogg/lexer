...
Builder::Builder(
        const std::size_t init_state, const std::size_t next_state, Nfa::Transitions_t transitions,
...
const Nfa::Transitions_t& Builder::transitions() const
{
    return transitions_;
}

const Nfa::Accept_states_t& Builder::accept_states() const
{
...
Builder& Builder::add_transition(const std::size_t from, const Label& label, const std::size_t to)
{
...
Builder& Builder::add_epsilon_transition(const std::size_t from, const std::size_t to)
{
...
Builder& Builder::add_accept_state(const std::size_t accept_state)
{
...
Builder& Builder::add_accept_state(const std::size_t accept_state, const Token& token)
{
