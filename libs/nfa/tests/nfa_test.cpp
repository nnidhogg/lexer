...
TEST_F(Nfa_test, Any_of)
{
    ...
    const auto q1{nfa.step_state()};
    const auto q2{nfa.step_state()};
...
TEST_F(Nfa_test, Branch_ab)
{
    ...
    EXPECT_EQ(Simulation::run(result, "a"), Result_t(token, 1));
    EXPECT_EQ(Simulation::run(result, "b"), Result_t(token, 1));
    EXPECT_EQ(Simulation::run(result, "ab"), Result_t(token, 1));
    EXPECT_EQ(Simulation::run(result, "aa"), Result_t(token, 1));
...
TEST_F(Nfa_test, Repeat_abc)
{
    ...
    EXPECT_EQ(Simulation::run(result, ""), Result_t(token, 0));
    EXPECT_EQ(Simulation::run(result, "a"), Result_t(token, 0));
    EXPECT_EQ(Simulation::run(result, "ab"), Result_t(token, 0));
...
TEST_F(Nfa_test, Numeric_branch)
{
    ...
    EXPECT_EQ(Simulation::run(result, "45"), Result_t(token, 2));
    EXPECT_EQ(Simulation::run(result, "123"), Result_t(token, 3));
    EXPECT_EQ(Simulation::run(result, "1234"), Result_t(token, 3));
...
TEST_F(Nfa_test, Epsilon_chain)
{
    ...
    EXPECT_EQ(Simulation::run(result, "a"), Result_t(token, 0));
    EXPECT_EQ(Simulation::run(result, "ab"), Result_t(token, 0));
    EXPECT_EQ(Simulation::run(result, "abc"), Result_t(token, 0));
}
